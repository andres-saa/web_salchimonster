...
<template>
    <div class=" grid col-12 lg:col-10 m-auto p-3 m-0 mb-8" style="max-width: 1024px">
        ...
        <div style=" ;
        border-radius: 1rem; overflow: hidden;" class="col-12 lg:col-6 p-0 mb-3 lg:p-3 m-0" v-for=" sede in sedes.filter(sede => sede.city_id)">
...
;
                ...
                <p class="xl:text-xl text-l m-0 " style="font-weight: bold; color:var(--primary-color)"><span class="pr-4" style="text-transform: uppercase;"><i :class="PrimeIcons.MAP_MARKER" style="color: var(--primary-color); font-weight: bold;"></i></span>{{cities?.filter(s => sede.city_id == s.city_id )[0]?.city_name}} <span style="font-weight: normal; padding-left: 1rem; color: white;">{{ sede.site_address }}</span> <p style="color: white;">SALCHIMONSTER {{sede.site_name}}</p></p>



                <p class="xl:text-xl text-l   " style="font-weight:normal ; color:white"><span class="pr-4"><i class="text-l p-0" :class="PrimeIcons.WHATSAPP" style="font-weight: bold; color: rgb(58, 255, 58);"></i></span>{{ sede.site_phone   }}  </p>
