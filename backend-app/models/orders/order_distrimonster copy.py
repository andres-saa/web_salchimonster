...
class Order2:
    ...
    def create_order_entry(self, user_id, order_data):
        ...
        if order_data.payment_method_id == 6:
            self.create_or_update_event(3, 32, 1132, "3 minutes", False)
            return order_id
    ...
    def procesar_carrito(self, cart):
        def calculate_total_product(product):
            ...
            # Calcular el descuento total: diferencia por unidad * cantidad 
            # + monto descuento de delivery (si existe)
            ...
            # Agregar el descuento calculado al producto
        ...
        for product in cart:
            ...
            product["pedido_precio"] = int(total_producto)  # Aseguramos que sea entero
