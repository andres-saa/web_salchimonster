...
@site_document_router.post("/site_document")
...
@site_document_router.put("/site_document/{document_id}")
...
@site_document_router.post('/upload-site-documet/')
...
@site_document_router.get("/get-site-document/{site_name}/{type_document}")
...
def get_site_documents_info(site_id: str):
    ...
    data = document_instance.select_document_by_id(site_id)  # Este es un método hipotético
    document_instance.close_connection()
    return data
                   

@site_document_router.post("/insert/site-document")
