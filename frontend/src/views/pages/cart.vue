        ...
        <div class=" col-12 xl:col-5   "
            ...
            <div class="productos">
                <div class="producto" v-for="product in products"
                    ...
                    <p v-if="product.product.adiciones.length > 0" class="col-12 p-0 pl-4" style="font-weight: bold;">
                        ADICIONES</p>
                    ...
                    <p v-if="product.product.salsas.length > 0" class="col-12 p-0 pl-4 mt-4" style="font-weight: bold;">
                        SALSAS</p>
                    <div class="col-12 p-0 pl-4 "
                        style="display: flex; justify-content: space-between; align-items:center ;"
                        v-for="salsa in product.product.salsas">
