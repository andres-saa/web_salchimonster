import{_ as f,d as S,f as y,z as x,g as b,q as A,h as p,o as v,c as O,a as o,t as u,u as _,C as m,i as r,E as h,p as I,b as $}from"./index-7e517879.js";import{u as E}from"./user-b46535f7.js";const i=a=>(I("data-v-7916e776"),a=a(),$(),a),C={class:"p-2 col-12 my-3",style:{height:"auto","min-height":"90vh",display:"flex","justify-content":"center","align-items":"center"}},w={class:"shadow-3 p-4",style:{"border-radius":"0.5rem","max-width":"500px"}},D={class:"text-4xl text-center mt-5",style:{"font-weight":"bold"}},R=i(()=>o("p",{class:"text-2xl text-center mb-5",style:{"font-weight":"bold"}},"🔥MUCHAS GRACIAS POR TU COMPRA!🔥",-1)),B={class:"text-4xl text-center my-5",style:{"font-weight":"bold","text-transform":"uppercase"}},U=i(()=>o("span",{class:"text-2xl"},"ID DEL PEDIDO",-1)),M=i(()=>o("br",null,null,-1)),N=i(()=>o("p",{class:"text-2xl text-center my-3 p-3",style:{"border-radius":".3rem","background-color":"var(--primary-color)",color:"white"}},"Hemos recibido tu pedido y en breve será despachado",-1)),L={style:{display:"flex","flex-direction":"column",gap:"1rem"}},k={__name:"gracias",setup(a){const g=S(),n=y(""),t=x(),s=E();return b(()=>{var c,l;n.value=`Hola soy *${s.user.name.toUpperCase()}* 🤗 acabo de hacer el siguiente pedido en la página web. El número de la orden es *#${t.last_order}*.
